...
skin_light_red = SkinLightProperties(
    num_cycles, cycle_duration, mean_energy_red, hit_probability_red
)
skin_light_ir = SkinLightProperties(
    num_cycles, cycle_duration, mean_energy_ir, hit_probability_ir
)
